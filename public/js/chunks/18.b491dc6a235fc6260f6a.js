...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    'role_id': function role_id(val) {
      ...
      //     }
      // })
      var roleIndex = this.roles.findIndex(function (role) {
        return role.id == val;
      });
      var permissionsIndex = this.roles[roleIndex].permissions; // console.log(permissionsIndex)
    ...
    getAllRoles: function getAllRoles() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_10___default.a.get('all-roles', {
        ...
        if (response.data.data.length > 0) {
          _this.role_id = response.data.data[0].id;
          if (response.data.data[0].permissions) _this.all_routes = JSON.parse(response.data.data[0].permissions);
        }
      });
    },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                data = JSON.stringify(_this2.all_routes);
                _context.next = 3;
              ...
              case 3:
                ...
                if (res.status === 200) {
                  _this2.makeToast('success', 'Permissions updated successfully');
                }
  ...
  created: function created() {
    ...
    this.$router.options.routes.forEach(function (route) {
      if (route.name) {
        ...
        _this3.default_all_routes.push({
          name: route.name,
          read: false,
          write: false,
          "delete": false,
