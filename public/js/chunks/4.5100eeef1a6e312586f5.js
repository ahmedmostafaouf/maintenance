...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_readOnlyError_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/readOnlyError.js */ "./node_modules/@babel/runtime/helpers/esm/readOnlyError.js");
/* harmony import */ var _home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/defineProperty.js */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }, Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_components, "BRow", bootstrap_vue__WEBPACK_IMPORTED_MODULE_7__["BRow"]), Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_components, "BCol", bootstrap_vue__WEBPACK_IMPORTED_MODULE_7__["BCol"]), Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_components, "BFormGroup", bootstrap_vue__WEBPACK_IMPORTED_MODULE_7__["BFormGroup"]), Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_components, "BFormInput", bootstrap_vue__WEBPACK_IMPORTED_MODULE_7__["BFormInput"]), Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_components, "vSelect", vue_select__WEBPACK_IMPORTED_MODULE_6___default.a), Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_components, "BFormFile", bootstrap_vue__WEBPACK_IMPORTED_MODULE_7__["BFormFile"]), Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_components, "ToastificationContent", _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_8__["default"]), _components),
  directives: {
  ...
  methods: {
    ...
    selectImgFile: function selectImgFile() {
      ...
      if (imgFile && imgFile[0]) {
        ...
        reader.onload = function (e) {
          ...
          _this.organization.logo = imgFile[0];
        };
    ...
    create: function create(url) {
      ...
      for (var _key in this.organization) {
        formData.append(_key, this.organization[_key]);
      }

      axios__WEBPACK_IMPORTED_MODULE_11___default.a.post(url, formData, config).then(function (data) {
        _this2.errors = {};

        _this2.makeToast('success', data.data.message);
        ...
        if (error.response) {
          _this2.makeToast('danger', error.response.data.message);
    ...
    getOrganization: function getOrganization() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_11___default.a.get("/organizations/".concat(this.$route.params.id, "/edit")).then(function (_ref) {
        var data = _ref.data;

        if (data.status) {
          Object.keys(_this3.organization).forEach(function (key) {
            if (key == 'logo') _this3.filePreview = data.organization[key];else _this3.organization[key] = data.organization[key];
          });
          _this3.qr_code = data.organization.qr_code;
          _this3.organization.id = data.organization.id;
        }
      });
    },
    update: function update() {
      ...
      for (var _key2 in this.organization) {
        if ( true && this.organization[_key2] !== null, Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_readOnlyError_js__WEBPACK_IMPORTED_MODULE_0__["default"])("key")) {
          formData.append(_key2, this.organization[_key2]);
          alert("HEY");
        } else {
          formData.append(_key2, this.organization[_key2]);
        }
      ...
      axios__WEBPACK_IMPORTED_MODULE_11___default.a.patch("/organizations/".concat(this.$route.params.id), formData, config).then(function (data) {
        _this4.errors = {};

        _this4.makeToast('success', data.data.message);
        ...
        if (error.response) {
          _this4.makeToast('warning', error.response.data.message);
