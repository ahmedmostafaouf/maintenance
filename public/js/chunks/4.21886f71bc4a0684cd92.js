...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    update: function update() {
      ...
      for (var key in this.organization) {
        if ( true && this.organization[key] !== null, Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_readOnlyError_js__WEBPACK_IMPORTED_MODULE_0__["default"])("key")) {
          formData.append(key, this.organization[key]);
          alert("HEY");
        } else {
          formData.append(key, this.organization[key]);
