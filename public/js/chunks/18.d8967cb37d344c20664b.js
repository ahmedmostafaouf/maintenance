...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BFormValidFeedback: bootstrap_vue__WEBPACK_IMPORTED_MODULE_8__["BFormValidFeedback"],
  ...
  watch: {
    'role_id': function role_id(val) {
      ...
      this.roles.map(function (item) {
        if (item.id == val) {
          if (item.permissions) {
            console.log(Object(E_ahmed_moheb_bot_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_1__["default"])(JSON.parse(item.permissions)));
            _this.all_routes = JSON.parse(JSON.parse(item.permissions));
          }
        }
      }); // let roleIndex = this.roles.findIndex(role => role.id == val);
      // let permissionsIndex = this.roles[roleIndex].permissions
      // // console.log(permissionsIndex)
      // // console.log(this.default_all_routes)
      // if(!permissionsIndex){
      //     this.all_routes = this.default_all_routes
      // }else{
      //     console.log(JSON.parse(permissionsIndex))
      //     this.all_routes = JSON.parse(permissionsIndex);
      // }
    }
  },
  methods: {
    getAllRoles: function getAllRoles() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_11___default.a.get('all-roles', {
        headers: {
    ...
    assignRole: function assignRole() {
      ...
      return Object(E_ahmed_moheb_bot_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee() {
        var data, res;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_11___default.a.post('assign-role', {
                  'role': _this3.role_id,
                  'permissions': data
                }, {
                  headers: {
  ...
  created: function created() {
    ...
    this.$router.options.routes.forEach(function (route) {
      if (route.name) {
        ...
        _this4.default_all_routes.push({
          name: route.name,
          read: false,
          write: false,
          "delete": false,
