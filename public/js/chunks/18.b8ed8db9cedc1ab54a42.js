...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    'role_id': function role_id(val) {
      ...
      var permissionsIndex = this.roles[roleIndex].permissions;
      console.log(permissionsIndex);
      console.log(JSON.parse(this.default_all_routes));

      if (!permissionsIndex) {
        this.all_routes = JSON.parse(this.default_all_routes);
      } else {
        this.all_routes = permissionsIndex;
      }
    }
  },
  methods: {
