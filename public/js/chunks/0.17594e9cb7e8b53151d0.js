...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    searchTermProp: function searchTermProp(val) {
      this.searchTerm = val;
      this.loadItems();
    }
  },
  ...
  methods: {
    ...
    updateParams: function updateParams(newProps) {
      this.serverParams = Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(_home_hanan_projects_bot_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, this.serverParams), newProps);
    },
    ...
    loadItems: function loadItems() {
      ...
      this.isLoading = true;
      axios__WEBPACK_IMPORTED_MODULE_7___default.a.get("".concat(this.url, "?searchTerm=").concat(this.searchTerm, "&page=").concat(this.serverParams.page, "&per_page=").concat(this.serverParams.perPage, "&field=").concat(this.serverParams.sort.field, "&type=").concat(this.serverParams.sort.type)).then(function (response) {
