...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    editService: function editService(form) {
      var _this = this;

      axios.patch("/services/".concat(this.$route.params.id), form).then(function (data) {
        _this.errors = {};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getService: function getService() {
      ...
      axios.get("/services/".concat(this.$route.params.id, "/edit")).then(function (_ref) {
        var data = _ref.data;

        if (data.status) {
          Object.keys(_this2.form).forEach(function (key) {
            return _this2.form[key] = data.service[key];
          });
        }
      });
    }
