...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    loadItems: function loadItems() {
      ...
      this.isLoading = true;
      axios__WEBPACK_IMPORTED_MODULE_6___default.a.get("".concat(this.url, "?searchTerm=").concat(this.searchTerm, "&page=").concat(this.serverParams.page, "&per_page=").concat(this.serverParams.perPage, "&field=").concat(this.serverParams.sort.field, "&type=").concat(this.serverParams.sort.type), {
        headers: {
