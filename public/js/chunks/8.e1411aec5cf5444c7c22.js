...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      logoAppImg: __webpack_require__(/*! @/assets/images/logo/bot.png */ "./resources/js/src/assets/images/logo/bot.png")
    };
  },
  computed: {
  ...
  methods: {
    login: function login() {
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_sanctum_useSanctum__WEBPACK_IMPORTED_MODULE_10__["default"].login({
            email: _this.userEmail,
            password: _this.password
          }).then(function (response) {
            var userData = response.data.data.userData;
            _auth_sanctum_useSanctum__WEBPACK_IMPORTED_MODULE_10__["default"].setToken(response.data.data.accessToken);
            _auth_sanctum_useSanctum__WEBPACK_IMPORTED_MODULE_10__["default"].setRefreshToken(response.data.data.refreshToken);
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("b-img", { attrs: { src: _vm.logoAppImg } }),
              _vm._v(" "),
