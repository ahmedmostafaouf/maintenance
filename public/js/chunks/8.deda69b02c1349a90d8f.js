...
/* harmony import */ var _auth_sanctum_useSanctum__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/auth/sanctum/useSanctum */ "./resources/js/src/auth/sanctum/useSanctum.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      logo: '@/assets/images/logo/bot.png'
    };
  },
  computed: {
  ...
  methods: {
    login: function login() {
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_sanctum_useSanctum__WEBPACK_IMPORTED_MODULE_9__["default"].login({
            email: _this.userEmail,
            password: _this.password
          }).then(function (response) {
            var userData = response.data.data.userData;
            _auth_sanctum_useSanctum__WEBPACK_IMPORTED_MODULE_9__["default"].setToken(response.data.data.accessToken);
            _auth_sanctum_useSanctum__WEBPACK_IMPORTED_MODULE_9__["default"].setRefreshToken(response.data.data.refreshToken);
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("b-img", { attrs: { src: _vm.logo, alt: "logo" } }),
              _vm._v(" "),
