...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    selectImgFile: function selectImgFile() {
      ...
      if (imgFile && imgFile[0]) {
        ...
        reader.onload = function (e) {
          ...
          _this.organization.logo = e.target.files[0];
        };

        reader.readAsDataURL(imgFile[0]); //this.$emit('fileInput', imgFile[0])
      }
    },
    ...
    create: function create(url) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_7___default.a.post(url, data, config).then(function (data) {
        _this2.errors = {};
