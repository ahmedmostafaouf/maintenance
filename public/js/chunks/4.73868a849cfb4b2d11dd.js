    ...
    update: function update() {
      ...
      for (var key in this.organization) {
        if (this.organization[key] !== null) {
          form.append(key, this.organization[key]);
        }
      }

      axios__WEBPACK_IMPORTED_MODULE_10___default.a.put("/organizations/".concat(this.$route.params.id), formData, config).then(function (data) {
        _this4.errors = {};
