...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getAllRoles: function getAllRoles() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.get('all-roles', {
        headers: {
        ...
        if (response.data.data.length > 0) {
          ...
          console.log(response.data.data[0].permissions);
          _this.all_routes = JSON.parse(response.data.data[0].permissions);
        }
      });
    },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('assign-role', {
                  'role': _this2.role_id,
                  'permissions': data
                }, {
                  headers: {
